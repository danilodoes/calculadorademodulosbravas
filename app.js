...
import { getPortas, getCatracas, getVeiculos, getVeiculosRF, getAntiCarona, getAudio, getControleVagasEntrada, getControleVagasSaida, getElevadores, getAndares, getSensorNivel, getIluminacao, getEstacionamentoEntradas, getEstacionamentoSaidas, getDisplay } from "./src/controller/utils/getFields.js"
import { calcAudio } from "./src/model/audio.js"
import { calcCatracaIP } from "./src/model/catraca.js"
import { calcDisplay } from "./src/model/display.js"
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btnCalcular.addEventListener("click", () => {
    ...
    // * Calcula e mostra a quantidade de: Módulos Display IP
    calcDisplay(qtdDisplay)

    // * Calcula e mostra a quantidade de: Módulos Acesso Programável
    calcModAcesso(qtdPortas, qtdCatracas, qtdVeiculos, qtdVeiculosRF, qtdAcessosAntiCarona, qtdAudio, qtdControleVagasEntrada, qtdControleVagasSaida, qtdElevadores, qtdAndares, qtdSensorNivel, qtdIluminacao, qtdTotensEntrada, qtdTotensSaida, qtdDisplay)
